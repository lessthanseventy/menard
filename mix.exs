defmodule Menard.MixProject do
  ...
  # for an alias. `hex.publish` builds the docs, so it needs ex_doc's env too.
  def cli, do: [preferred_envs: [precommit: :test, docs: :docs, "hex.publish": :docs]]
  ...
  def project do
    [
      ...
      deps: [
        ...
        # Optional, so a host taking menard as a library does not take finch, mint and the rest.
  ...
  defp docs do
    [
      ...
      extras: ["README.md", "CHANGELOG.md", "docs/scope.md", "docs/live.md", "docs/adapters.md"]
    ]
  end
